...
public class Grandpa extends Creature implements Runnable {
    ...
    public Grandpa(){
        ...
        this.name = "爷爷";
        this.evil = false;
        this.path = this.getClass().getClassLoader().getResource("pics/grandpa.jpg");
                        ...
                        try{
                            ...
                            if(a == 0){//爷爷赢
                                ...
                                synchronized (battleground) {
                                    battleground.getGround()[sx][sy].getCre().setAlive(false);//爷爷死亡
